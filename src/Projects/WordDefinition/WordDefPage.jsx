...
useEffect(() => {
    setObj(wordsStore.wordInfo)}, [wordsStore.wordInfo]);
    useEffect(() => wordObj.length > 0 ? setEmpty(false) : setEmpty(true), [wordObj.length])
...
return (
        ...
        <div className='word-page'>
            ...
            <div className='word-page__transcript'>
               <div className='word-page__transcript_word'> {!isEmpty ? wordObj[0].word : ''}</div>
               <div className='word-page__transcript_letters'>{!isEmpty ? wordObj[0].phonetic : ''}</div>
            </div>
            ...
            <div className={isOpen ? 'word-page__definitions' : 'word-page__definitions hiden'}>
                ...
                !isEmpty ?
                wordObj[0].meanings[0].definitions.slice(0, 2).map(element => <div className = 'word-page__definitions_definition'>{element.definition}</div>) : ''}
